...
LOCAL_MODULE_FILENAME := libffmpeg_codec
LOCAL_SRC_FILES := s_android_ffmpeg_FFmpegNative.c
LOCAL_LDLIBS := -llog -ljnigraphics -lz -landroid -L
LOCAL_SHARED_LIBRARIES := swresample-0-prebuilt avcodec-55-prebuilt avdevice-55-prebuilt avfilter-4-prebuilt avformat-55-prebuilt avutil-52-prebuilt swscale-2-prebuilt
