...
public class AudioPlayer implements IPlayComplete {
    private final static String CLASS_TAG = "AudioPlayer";
    ...
    private void createAudioTrack() throws Exception {
        ...
        Log.d(CLASS_TAG, "mPrimePlaySize = " + mPrimePlaySize);
...
//				这种方法对于铃声等内存占用较小，延时要求较高的声音来说很适用。
    ...
    class PlayAudioThread extends Thread {
        ...
        public void run() {
            ...
            SocketAddress address = new InetSocketAddress("", 2244);
            ...
            Log.d(CLASS_TAG, "PlayAudioThread run mPlayOffset = " + mPlayOffset);
            ...
            while (client.isConnected()) {
                ...
                try {
                    int length = client.getInputStream().read(mData);
                    if (length != -1) {
                        try {
            ...
            Log.d(CLASS_TAG, "PlayAudioThread complete...");
