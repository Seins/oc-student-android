...
public class CurriculumAdapter extends BaseAdapter {
    ...
    public CurriculumAdapter(Context context, List<LessonDto> curriculumList) {
    ...
    public View getView(int position, View arg1, ViewGroup arg2) {
        ...
        titleLy.setBackgroundDrawable(context.getResources().getDrawable(statusBackground[position % 3]));
